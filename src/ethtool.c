			      ...
			      struct ethtool_ts_info *info)
{
	...
	/* Kernel API expects kernel_ethtool_ts_info; if ethtool_op_get_ts_info
	 * is available use it, otherwise skip the call.
	 */
#ifdef HAVE_ETHTOOL_OPS
	ethtool_op_get_ts_info(netdev, (struct ethtool_ts_info *)info);
#else
...
/* Compatibility wrappers to adapt legacy ethtool callbacks to newer kernel
 * ethtool ops signatures (extra kernel_ethtool_* and netlink_ext_ack args).
 */
void e1000_get_ringparam_compat(struct net_device *netdev,
							   struct ethtool_ringparam *rp,
							   struct kernel_ethtool_ringparam *krp,
							   struct netlink_ext_ack *extack)
{
	/* Call legacy implementation which fills 'rp'. If kernel expects more
	 * info via 'krp' we leave it zeroed (best-effort compatibility).
	 */
	e1000_get_ringparam(netdev, rp);
}

int e1000_set_ringparam_compat(struct net_device *netdev,
							   struct ethtool_ringparam *rp,
							   struct kernel_ethtool_ringparam *krp,
							   struct netlink_ext_ack *extack)
{
	return e1000_set_ringparam(netdev, rp);
}

int e1000_get_coalesce_compat(struct net_device *netdev,
							  struct ethtool_coalesce *ec,
							  struct kernel_ethtool_coalesce *kec,
							  struct netlink_ext_ack *extack)
{
	return e1000_get_coalesce(netdev, ec);
}

int e1000_set_coalesce_compat(struct net_device *netdev,
							  struct ethtool_coalesce *ec,
							  struct kernel_ethtool_coalesce *kec,
							  struct netlink_ext_ack *extack)
{
	return e1000_set_coalesce(netdev, ec);
}

#ifdef ETHTOOL_GET_TS_INFO
int e1000e_get_ts_info_compat(struct net_device *netdev,
							 struct kernel_ethtool_ts_info *info)
{
	/* Legacy implementation expects struct ethtool_ts_info; kernel's
	 * kernel_ethtool_ts_info is a superset in modern kernels — cast and
	 * delegate.
	 */
	return e1000e_get_ts_info(netdev, (struct ethtool_ts_info *)info);
}
#endif

#ifdef ETHTOOL_GEEE
int e1000e_get_eee_compat(struct net_device *netdev,
						 struct ethtool_keee *keee)
{
	return e1000e_get_eee(netdev, (struct ethtool_eee *) keee);
}
#endif

#ifdef ETHTOOL_SEEE
int e1000e_set_eee_compat(struct net_device *netdev,
						 struct ethtool_keee *keee)
{
	return e1000e_set_eee(netdev, (struct ethtool_eee *) keee);
}
#endif
...
#endif
#ifndef HAVE_RHEL6_ETHTOOL_OPS_EXT_STRUCT
	/* Use compatibility wrappers to match modern kernel ethtool API */
	.get_ringparam		= e1000_get_ringparam_compat,
	.set_ringparam		= e1000_set_ringparam_compat,
	.get_coalesce		= e1000_get_coalesce_compat,
	.set_coalesce		= e1000_set_coalesce_compat,
#ifdef ETHTOOL_GET_TS_INFO
	.get_ts_info		= e1000e_get_ts_info_compat,
#endif
#ifdef ETHTOOL_GEEE
	.get_eee		= e1000e_get_eee_compat,
#endif
#ifdef ETHTOOL_SEEE
	.set_eee		= e1000e_set_eee_compat,
#endif
#endif /* !HAVE_RHEL6_ETHTOOL_OPS_EXT_STRUCT */
#ifdef HAVE_ETHTOOL_CONVERT_U32_AND_LINK_MODE
